    ...
    const loginHandle = (userName, password) => {
        if(data.isValidPassword && data.isValidUser) {
            ...
            if ( data.username.length == 0 || data.password.length == 0 ) {
                Alert.alert('Lỗi đăng nhập!', 'Tài khoản và mật khẩu không được để trống.', [
                    {text: 'Đồng ý'}
                ]);
                return;
            }
        ...
        >
            ...
            { 
                ...
                <Animatable.View animation="fadeInLeft" duration={500}>
                    <Text style={styles.errorMsg}>Mã sinh viên tối thiểu 10 ký tự.</Text>
                </Animatable.View>
            }
            ...
            { 
                ...
                <Animatable.View animation="fadeInLeft" duration={500}>
                    <Text style={styles.errorMsg}>Mật khẩu tối thiểu 6 ký tự.</Text>
                </Animatable.View>
            }
